$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        //Question 3
        if(answer3=="Hartnell College"){
            correctAnswer($("question3-feedback"));
        } else{
            incorrectAnswer($("#question3-feedback"));
        }
        $("#question3-feedback").append("The answer is <strong>Hartnell College</strong>");
        //Question 4
        if(answer4=="A"){
        ...
        $("#question4-feedback").append("The answer is <strong>7 graduate majors</strong>");
        //Displays quiz score
